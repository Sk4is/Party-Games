...
export const LPRLobby: React.FC<LPRLobbyProps> = ({
  ...
  const handleCopyLink = () => {
    const url = `${window.location.origin}${window.location.pathname}?game=la-peor-respuesta&room=${roomState.code}`;
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="bg-stone-900/90 border border-stone-800 rounded-3xl p-5 shadow-xl relative overflow-hidden">
              ...
              <p className="text-xs text-stone-400 leading-relaxed">
                Invita a tus amigos compartiendo el código o el enlace. Cada jugador responderá y votará en secreto desde su propio dispositivo.
              </p>
            </div>
              ...
              <div>
                <div className="flex items-center justify-between text-xs mb-2">
                  ...
                  <span className="font-bold text-white font-mono">
                    {roomState.config.totalRounds === -1 ? 'Modo Libre (∞)' : `${roomState.config.totalRounds} rondas`}
                  </span>
                </div>
          ...
          <div className="lg:col-span-7 space-y-4">
            <div className="bg-stone-900/90 border border-stone-800 rounded-3xl p-5 shadow-xl">
              <div className="flex items-center justify-between mb-4 pb-3 border-b border-stone-800">
                ...
                <span className="text-xs text-stone-400">Mínimo 3</span>
              </div>
