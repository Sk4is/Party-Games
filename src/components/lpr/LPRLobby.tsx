        ...
        {isHost ? (
          <div>
            <button
              ...
              className="w-full py-4 px-6 rounded-2xl bg-[#FF3B4F] hover:bg-[#E6293D] disabled:opacity-40 disabled:cursor-not-allowed text-white font-black text-sm sm:text-base uppercase tracking-wider transition-all shadow-xl shadow-[#FF3B4F]/25 active:scale-[0.99] flex items-center justify-center gap-2 cursor-pointer"
            >
              <Play className="w-5 h-5 fill-current" />
              <span>Iniciar Partida</span>
            </button>
            {!canStart && (
              <p className="text-center text-xs text-[#FF3B4F]/90 mt-2.5 font-medium">
          ...
          <div className="p-4 rounded-2xl bg-stone-900/60 border border-stone-800/80 text-center">
            <div className="flex items-center justify-center gap-2 text-stone-300 text-sm font-semibold mb-1">
              <Sparkles className="w-4 h-4 text-[#FF3B4F] animate-spin" />
